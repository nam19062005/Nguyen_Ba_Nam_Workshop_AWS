...
| 5 | - Chuẩn bị nội dung ảnh kiến trúc cho tài liệu Workshop: <br>&emsp; + Xuất sơ đồ kiến trúc tổng thể → `static/images/2-Proposal/architecture.png` <br>&emsp; + Xuất sơ đồ Pipeline chi tiết → `static/images/5-Workshop/5.1-Workshop-overview/architecture.png` | 09/07/2026 | 09/07/2026 | Hugo Static Files |
