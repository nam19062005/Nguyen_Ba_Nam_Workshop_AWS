...
| 5 | - Prepare architecture images for Workshop documentation: <br>&emsp; + Export overall architecture diagram → `static/images/2-Proposal/architecture.png` <br>&emsp; + Export detailed Pipeline diagram → `static/images/5-Workshop/5.1-Workshop-overview/architecture.png` | 09/07/2026 | 09/07/2026 | Hugo Static Files |
