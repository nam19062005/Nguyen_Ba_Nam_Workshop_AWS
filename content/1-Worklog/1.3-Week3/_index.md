...
| --- | --- | --- | --- | --- |
| Mon | - Deep dive **Amazon S3**: Storage Classes, Versioning, Lifecycle Rules, Bucket Policy, Encryption (SSE-S3, SSE-KMS) <br> - Study **VPC Endpoints** (Gateway vs Interface) to understand how VPC services access S3 internally <br> - Update diagram: Add VPC boundary and S3 VPC Endpoint to architecture | 29/06/2026 | 29/06/2026 | AWS S3 & VPC Documentation |
| Tue | - Study **AWS IAM** advanced: IAM Roles vs Users, Trust Policy, `iam:PassRole` mechanism <br> - Learn **Least Privilege** principle and IAM Role design for each AWS service <br> - Add to architecture: IAM Roles (SageMaker Execution Role, Lambda Execution Role) and authorization flows | 30/06/2026 | 30/06/2026 | AWS IAM Best Practices |
| Wed | - **Standardize architecture layout v1.0:** <br>&emsp; + Clearly separate 5 layers with colors and borders <br>&emsp; + Add full resource names, region (`ap-southeast-1`), and labeled data flow arrows <br>&emsp; + Add **Legend** explaining symbols and colors | 01/07/2026 | 01/07/2026 | draw.io |
| Thu | - Draft **architecture description** for each component (Vietnamese): <br>&emsp; + Role of each AWS service <br>&emsp; + Auto-Retrain Data Flow <br>&emsp; + Real-time Inference Flow | 02/07/2026 | 02/07/2026 | AWS Architecture Blog |
| Fri | - Review architecture v1.0 with Mentor: Confirm accuracy and consistency with the team's actual code <br> - Apply feedback: Clearer separation between SageMaker VPC and Public Internet boundary | 03/07/2026 | 03/07/2026 | Mentor Feedback |
